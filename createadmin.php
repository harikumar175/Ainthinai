...
<p class="w3-center"><em>Ainthinai.Nellai</em></p>
        ...
        <i class="fa fa-circle fa-fw w3-text-green w3-xlarge w3-margin-right" aria-hidden="true"></i>Enter the details and make sure to remember the password and username <br>
...
?>
      ...
      <form action="" target="" method="POST">
            ...
            </form>&nbsp;&nbsp;<a href="index.php"></a><button class="w3-button w3-green w3-left w3-section" type="submit" name="submit">
