...
<body>
  <div class="w3-top">
    ...
    <div class="bgimg-4 w3-display-container w3-opacity-min"id="projects">
      <div class="w3-display-middle">
        <span class="w3-xxlarge w3-text-white w3-wide"><u><b>PROJECTS</b></u></span>
      </div>
    </div>
  <div class="w3-content w3-container w3-padding-64" id="about">
    ...
    <p>Provide the data after the completion of each project.This data provides a ballistic report an progress status of planting saplings </p>
 ...
 echo"<table >";
  echo" <tr>
     <th>id</th>
      <th>Date</th>
      <th>Variant of Tree</th>
      <th>Number of Trees</th>
      <th>Location</th>
      <th>Ownership</th>
      <th>Ownership Phone number</th>
       </tr>";
